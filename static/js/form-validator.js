                                            ...
                                            if (events && field && message) {
                                                (function (events, field, message) {
                                                    $(document).on(events, field, function (event) {
                                                        ...
                                                        if (validationResult) {
                                                            _self.validationResults[field]["valid"] = validationResult.valid;
                                                        } else {
                                                            _self.validationResults[field]["valid"] = false;
                                                        }
                                                    });
        ...
        if (_form) {
            $(_form).submit(function (event) {
                ...
                for (var _validation in _validations) {
                    ...
                    if (result) {
                        _self.validationResults[result.field]["valid"] = result.valid;
                    }
                }
                for (var _validationResult in _self.validationResults) {
                    console.log(_self.validationResults[_validationResult]["valid"]);
                }
                console.log(JSON.stringify(_self.validationResults));
